          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-violet-900/20 to-fuchsia-900/20 backdrop-blur-sm border border-violet-500/20 rounded-xl p-6 text-center"
              >
                ...
                <h3 className="text-3xl md:text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-fuchsia-400">
